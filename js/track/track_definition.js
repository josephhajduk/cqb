var track_definition = function() {
    ...
    this.background_actor = function (director) {
            return new CAAT.SpriteImage()
    ...
    this.foreground_actor = function (director) {
            return new CAAT.SpriteImage()
    ...
    this.obstacles = function(t,car,check_point_progress) {
