var car = function(color,start_position,start_direction) {
    ...
    this.point_car(start_direction)
    ...
    this.stats = {
        ...
        tires: function(car_direction,force,mass,engine){ return car_direction },
        mass: 100,
    }
    ...
    this.physics = function(time,ttime,track_def) {
        ...
        if ( -1!=prevTime ) {
            ...
            var engine_x = throttle * this.stats.engine_force(v_abs)
            var engine_y = throttle * this.stats.engine_force(v_abs)
            ...
            // tire physics
            a_x = this.stats.tires(car_direction,force,mass,engine).x 
            a_y = this.stats.tires(car_direction,force,mass,engine).y 
